...
var currentSavings = parseFloat(
  document.getElementById("savingsAmount").textContent.replace("$", "")
);
...
function updateGoalLabel() {
  ...
  savingsChart.options.plugins.annotation.annotations.line1.label.content =
    "Goal: $" +
    savingsGoal +
    " (You need $" +
    remaining.toFixed(2) +
        ...
        annotations: {
          line1: {
            ...
            label: {
              ...
              xAdjust: 0, // Adjust label's X position (positive or negative value). Adjust as needed.
              yAdjust: -50, // Adjust label's Y position (positive or negative value). Adjust as needed.
            },
          },
        },
      },
